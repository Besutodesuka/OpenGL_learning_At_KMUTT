# Credit 
this repository is part of CPE494 course about 3D game development using C and opengl. in this course we use ample code from
Learn OpenGL repository and [https://learnopengl.com](https://learnopengl.com). make sure to check it out.
thankyou for such good resource help us learning things from scartch step by step.
...
- [3D animation state management](https://github.com/Besutodesuka/OpenGL_learning_At_KMUTT/tree/main/work_collections/3D_player_animation)
